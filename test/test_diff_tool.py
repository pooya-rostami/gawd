...
class TestTextDiffTool:
    ...
    def test_distance_similarity(self):
        assert gawd.distance([1, 2, 3, 4], [1, 2, 3, 4]) == 0 # Assuming find_matches returns [(1, 2, 0.25), (2, 3, 0.25), (3, 4, 0.25), (4, 5, 0.25)]
        assert gawd.distance([1, 2, 3, 4], [2, 3, 4, 5]) == sum(score for _, _, score in gawd.find_matches([1, 2, 3, 4], [2, 3, 4, 5])) / len(gawd.find_matches([1, 2, 3, 4], [2, 3, 4, 5])) # Assuming find_matches returns [(1, 2, 0.25), (2, 3, 0.25), (3, 4, 0.25), (4, 5, 0.25)]
